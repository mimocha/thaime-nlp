...
|-------|----------|--------|-----------------|-------|
| hun | หุ้น (stocks) | หั่น (chop) | 1.06× | Near-equal frequency — genuine ambiguity |
| chae | แชร์ (share) | เจ (encounter) | 1.48× | Low ratio — เจ is more common than แชร์ |
...
6. **The remaining errors are genuine ambiguity.** The 2 failures shared by all formulas (`hun`, `chae`) involve near-equal-frequency word pairs where the "expected" answer is debatable. These would need context (bigram scoring) to resolve correctly.
